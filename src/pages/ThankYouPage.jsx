          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              ...
              <div className="card" style={{ 
                border: 'none', 
                borderRadius: '15px', 
                boxShadow: '0 10px 40px rgba(168, 10, 244, 0.1)',
                marginBottom: '40px'
              }}>
                <div className="card-body" style={{ padding: '40px' }}>
                  <div className="row">
                    <div className="col-md-8">
                      <h3 style={{ color: '#a80af4', marginBottom: '20px' }}>
                    ...
                    <div className="col-md-4 text-center">
                      <div style={{ 
                        ...
                        borderRadius: '10px', 
                        padding: '30px 20px',
                        border: '2px dashed #a80af4'
                      }}>
                        <i className="fas fa-clock" style={{ fontSize: '3rem', color: '#a80af4', marginBottom: '15px' }}></i>
                        <h5 style={{ color: '#a80af4', marginBottom: '10px' }}>Estimated Time</h5>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="info-card" style={{ 
                    ...
                    <h5 style={{ color: '#a80af4', marginBottom: '15px' }}>
              ...
              <div className="text-center" style={{ marginTop: '40px' }}>
                <Link 
                  ...
                  onMouseOver={(e) => e.target.style.backgroundColor = '#8a08c9'}
                  onMouseOut={(e) => e.target.style.backgroundColor = '#a80af4'}
                >
                ...
                <Link 
                  ...
                  style={{ 
                    ...
                    fontSize: '1.1rem',
                    fontWeight: '600',
                    border: '2px solid #a80af4',
                    display: 'inline-block',
                    transition: 'all 0.3s ease'
                  }}
                  onMouseOver={(e) => {
                    e.target.style.backgroundColor = '#a80af4';
                    e.target.style.color = 'white';
                  }}
                  onMouseOut={(e) => {
                    e.target.style.backgroundColor = 'transparent';
                    e.target.style.color = '#a80af4';
                  }}
                >
